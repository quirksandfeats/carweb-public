# The Car Web — engineering log

> **What this file is.** The project's full development log, kept as it was
> written: every design decision, the reasoning behind it, the measured
> benchmarks, and the bug reports that produced most of the features. It is
> long and it is not an introduction — start at [`../README.md`](../README.md)
> instead.
>
> Two things to know while reading. This is the **public build**: the personal
> "My Database" road-test layer described throughout is **not included**, and
> its build step is off by default (`CARWEB_DB_LAYER`) — see
> [`../ATTRIBUTION.md`](../ATTRIBUTION.md) for why. And paths here are written
> relative to the repository root, not to this `docs/` directory.

An explorable knowledge graph of **6,790 car models (101 grouped into nameplate
families, spanning 394 individual generations), 1,130 makes and 2,356 people**
(2,253 designers · 139 chief engineers/project leads, some are both) from 1883
to today, with **19,653 real connections** — made-by, designed-by,
